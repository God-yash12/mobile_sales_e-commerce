const data = [
  {
    id: 1,
    question1: "Q: What is Refurbished Phone?",
    answer1:
  ...
  {
    id: 5,
    question1: "Q: Are refurbished phone inexpensive than new phones?",
    answer1:
  ...
  {
    id: 6,
    question1: "Q: Can i get warranty for a refurbished phone?",
    answer1:
  ...
  },
  {
    id: 9,
    question1:
      "Q: Can i transfer my data from my old phone to a refurbished phone?",
    answer1:
  ...
  },
  {
    id: 10,
    question1:
      "Q: How long it takes to receive a refurbished phone after ordering?",
    answer1:
      "The time it takes to receive a refurbished phone after ordering varies depending on factors such as the processing time, shipping method selected, and your location. Typically, we take very less time for the phone to be delivered.",
  },
  {
    id: 11,
    question1: "Q: Can i pay installments for a refurbished phone?",
    answer1:
      "Whether you can pay in installments for a refurbished phone depends on the payment options and policies. Some sellers offer financing or installment plans, allowing you to spread out the cost of the phone over time. Be sure to check the website or contact the customer service for information on payment options.",
  },
  {
    id: 12,
    question1: "Q: How do i know if a refurbished phone is authentica?",
    answer1:
  ...
  {
    id: 13,
    question1: "Q: Can i trade in my old phones for a refurbished phones?",
    answer1:
  ...
  },
  {
    id: 14,
    question1:
      "Q: How do i reset a refurbished phones to its factors settings?",
  ...
  {
    id: 15,
    question1: "Q: Can i get technical support for a refurbished phones?",
    answer1:
      "Yes, you can often get technical support for a refurbished phone from MobileGoo. We offer customer support services to assist with setup, troubleshooting, and any issues you may encounter with your refurbished phones. You can typically reach out to us via phone, email, or live chat for assistance.",
  },
  {
    id: 17,
  ...
  {
    id: 21,
    question1: "Q: Are unboxed phones are cost-effective?",
    answer1:
  ...
  {
    id: 22,
    question1: "Q: What is the condition of unboxed phone?",
    answer1:
  ...
  },
  {
    ...
    answer1: `At times, people who are fond of using latest technology/ change phones frequently, may simply return/ sell their phones after opening new packaging but with no/ minimal usage. Such phones are categorized as“open box/ unboxed phones”.
  ...
  {
    id: 24,
    question1: "Q: How unboxed/ open box phones are different from refurbished/ old phones?",
    answer1:`Brand/ Manufacturer Warranty:

At Mobilehub.shop, if you buy any unboxed/ open box phone, it will come with Brand/ Manufacturer warranty. Warranty period may vary from 0-12 months. However, in case of other old/ refurbished phones, there is no brand warranty. However, such phones come with Mobilegoo warranty.

Original Box:

Unboxed/ Open box phones comes in original brand box generally, however, other old/ refurbished phones, comes with Mobilehub box.
