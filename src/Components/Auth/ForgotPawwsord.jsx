...
const ForgotPassword = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-5xl w-full bg-white p-8 rounded-lg shadow-md flex flex-col md:flex-row">
        <div className="md:w-1/2 p-4 mx-4">
          ...
          <form className="mt-4 md:mt-20 p-3">
            <div className="mb-4 md:w-3/4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="email">Email</label>
              <p className="mt-4 mb-4 text-sm font-thin">We will send you an email to reset your password</p>
              <input
            ...
            <div className="flex items-center justify-between md:w-3/4">
              ...
              <a href="/login">
              <button
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline w-full"
                type="button"
              >
                Submit
              </button>
              ...
              <a href="/login">
                <button
                  className="bg-white-500 text-black font-bold pl-o pr-4 mr-20 rounded focus:outline-none focus:shadow-outline w-full"
                  type="button"
                >
                  Cancel
                </button>
