...
import Card from './BrandwarrentyCrad';

const DealsoftheDay = () => {
  const [products] = useState([
    {
      id: 1,
      name: 'Apple iPhone 15 Pro Max (UNBOX)',
    ...
    {
        id: 6,
        name: 'Samsung Galaxy S21 Ultra (UNBOX)',
  ...
  return (
    <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 mb-8">
      <div className="flex justify-center items-center gap-3 mb-6 pb-4">
        <img src="/src/assets/star.png" alt="" className="w-8 h-8" />
          <h2 className="text-3xl sm:lg md:2xl font-semibold text-center">Brand Warrenty</h2>
        <img src="/src/assets/star.png" alt="" className="w-8 h-8" />
      </div>
      <Slider {...settings}>
